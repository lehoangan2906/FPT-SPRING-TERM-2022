...
public class bst {
    ...
    */
	...
	public Node insertRec(Node root, String x){
		...
		if (x.compareTo(root.info) < 0)
			root.left = insertRec(root.left, x);
		else if (x.compareTo(root.info) > 0)
...
// Depth first search on binary tree
    ...
    */
	...
	public String minNode(Node root){
		Node current = root;
	...
	public String maxNode(Node root){
		Node current = root;
